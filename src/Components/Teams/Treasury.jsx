...
function TreasuryTeam(props) {
  ...
  useEffect(() => {
    const devteamcall = async () => {
      const response = await fetch(
        "https://nvdqwpdb-8000.inc1.devtunnels.ms/treasuryteam/gettreasuryteamdata",
        {
          method: "GET",
          headers: {
  ...
  const handleSubmit = async () => {
    const response = await fetch(
      "https://nvdqwpdb-8000.inc1.devtunnels.ms/treasuryteam/addtreasuryperson",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
